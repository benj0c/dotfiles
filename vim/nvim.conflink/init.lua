...
vim.keymap.set('n', '<leader>v', ':AV<CR>', { silent = true })
...
-- Setup autocmd to remove trailing whitespace before writing to buffer
      ...
      require('telescope').setup {
        ...
        -- defaults = {
          --   mappings = {
            ...
            -- pickers = {}
            defaults = {
              file_ignore_patterns = { "./^.git/*", "./node_modules/*", "node_modules", "^node_modules/*", "node_modules/*", "coverage/*" },
            },
            extensions = {
              ['ui-select'] = {
...
-- Define the GitHub_open function
local function GitHub_open(lines)
  local executable = "gh-url"
  local cmd = executable .. " " .. vim.fn.expand('%:p')
...
vim.api.nvim_create_user_command('Ghl', function() GitHub_open("true") end, {})
vim.api.nvim_create_user_command('Gh', function() GitHub_open("false") end, {})

-- Define the Bitbucket_open function
local function Bitbucket_open(lines)
  local executable = "bb-url"
  local cmd = executable .. " " .. vim.fn.expand('%:p')
...
vim.api.nvim_create_user_command('Bbl', function() Bitbucket_open("true") end, {})
vim.api.nvim_create_user_command('Bb', function() Bitbucket_open("false") end, {})
